// 물고기가 6마리 있다.
// 이들은 어항에 살고 있는데, 사막에 있다.
// 사막이 너무 더워서, 너무 건조해 물이 아주 빨리 증발한다.
...
int main(void)
{
	...
	startTime = clock();	// 현재 시간을 millisecond (1000분의 1초) 단위로 환산
	...
	while (1)
	{
		...
		// 레벨업을 할건지 체크 (레벨업은 20초마다 한 번씩 수행)
		...
		// 10초 -> 15초 (5초 : prevElapsedTime -> 15초) -> 25초 (10초 계산)
	}
