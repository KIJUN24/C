...
/* 
비밀번호를 입력 받아서
맞은 경우 -> 비밀 일기를 읽어와서 보여주고 계속 작성하도록 합니다.
...
int main(void)
{
	...
	// 비밀번호 : dlrlwns
	printf("\n\n === 비밀번호 확인 중... === \n\n");
	if (strcmp(password, "dlrlwns") == 0) // 비밀번호 일치
	{
		printf(" === 비밀번호 확인 완료 === \n\n");
		const char* fileName = "C:\\Users\\lkjun\\OneDrive\\바탕 화면\\C_Workspace\\C\\C_practice\\20220422_review\\8_파일입출력_END\\secretdiary.txt";
